...
$total_dana = mysqli_fetch_assoc(mysqli_query($conn,"
SELECT 
COALESCE(SUM(total),0) as total_dana
FROM permohonan_uang
WHERE (
    status='dicairkan'
    OR status='selesai'
...
AND MONTH(dicairkan_at)=MONTH(CURRENT_DATE())
AND YEAR(dicairkan_at)=YEAR(CURRENT_DATE())
"));

$total_dana_bulan_ini = $total_dana['total_dana'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="card-stat">
<div>
<p>Dana Cair Bulan Ini</p>

<h3 style="font-size:22px;">
Rp <?= number_format($total_dana_bulan_ini,0,',','.'); ?>
</h3>
